...
class Game():
    ...
    def _new_dot(self, color):
        ...
        return svg_str_to_pixbuf(
            self._header() + self._circle(self._dot_size / 2.,
                                          self._dot_size / 2.,
                                          self._dot_size / 2.) + self._footer())
    ...
    def _new_turtle(self):
        ...
        self._fill = '#404040'
        return svg_str_to_pixbuf(
            self._header() + self._turtle() + self._footer())
    ...
    def _turtle(self):
        ...
        svg += '%s%s%s%s%s%s%s%s%s%s' % ('   <path d="M 14.3 39.9 ',
                                         ...
                                         'C 17.1 43.9 15.5 42.1 14.3 39.9'
                                         ' Z" stroke_width="3.5" ',
                                         'fill="', self._fill, ';" stroke="',
                                         self._stroke, '" />\n')
        svg += '%s%s%s%s%s%s%s%s%s%s' % ('   <path d="M 19.0 15.4 ',
                                         ...
                                         'C 15.7 18.5 17.2 16.8 19.0 15.4'
                                         ' Z" stroke_width="3.5" ',
                                         'fill="', self._fill, ';" stroke="',
                                         self._stroke, '" />\n')
        ...
        svg += '%s%s%s%s%s' % ('   <path d="M 25.9 33.8 L 24.3 29.1 ',
                               'L 27.5 26.5 L 31.1 29.2 L 29.6 33.8',
                               ' Z" stroke_width="3.5" fill="',
                               self._stroke, ';" stroke="none" />\n')
